...
public class T04_PhantomReference {
    ...
    private static final ReferenceQueue<T05_M> QUEUE = new ReferenceQueue<>();


    public static void main(String[] args) {


        PhantomReference<T05_M> phantomReference = new PhantomReference<>(new T05_M(), QUEUE);
        ...
        new Thread(() -> {
            while (true) {
                Reference<? extends T05_M> poll = QUEUE.poll();
                if (poll != null) {
